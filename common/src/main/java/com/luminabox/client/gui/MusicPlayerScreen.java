...
public class MusicPlayerScreen extends Screen {
    ...
    public void extractBackground(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        super.extractBackground(context, scaledMouseX, scaledMouseY, delta);
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            context.centeredText(this.font, label, cardX + 40, cardY + 20 + i * 35, color);
        }
        ...
        if (activeTab == 0) {
            context.text(this.font, Component.translatable("gui.luminabox.local.title"), cardX + 90, cardY + 15, 0xFFFFFFFF, false);
            ...
            for (int i = 0; i < 9 && (scrollIndex + i) < playlist.size(); i++) {
                ...
                context.text(this.font, Component.literal(trackLine), textX, cardY + 41 + i * 20, color, false);
            }

            if (playlist.isEmpty()) {
                context.text(this.font, Component.translatable("gui.luminabox.local.no_music"), cardX + 95, cardY + 45, 0xFF888888, false);
                context.text(this.font, Component.translatable("gui.luminabox.local.instructions"), cardX + 95, cardY + 65, 0xFF888888, false);
                context.text(this.font, Component.literal("luminabox/local/"), cardX + 95, cardY + 85, 0xFF00FFCC, false);
            }
            ...
            context.text(this.font, Component.literal(statusIcon), cardX + 300, cardY + 276, statusColor, false);
            ...
            if (showingSearchResults) {
                context.text(this.font, Component.translatable("gui.luminabox.platform.search_results"), cardX + 90, cardY + 38, 0xFF00FFCC, false);
            } else {
                context.text(this.font, Component.translatable("gui.luminabox.platform.online_playlist"), cardX + 90, cardY + 38, 0xFF00FFCC, false);
            }
            ...
            for (int i = 0; i < 8 && (searchScrollIndex + i) < displayList.size(); i++) {
                ...
                context.text(this.font, Component.literal(trackLine), cardX + 95, cardY + 52 + i * 20, color, false);
                
                if (showingSearchResults) {
                    int addBtnX = cardX + 420;
                    int addBtnY = cardY + 52 + i * 20;
                    context.fill(addBtnX - 2, addBtnY - 2, addBtnX + 15, addBtnY + 12, 0x5500FFCC);
                    context.text(this.font, Component.literal("+"), addBtnX + 4, addBtnY, 0xFFFFFFFF, false);
                }
            }
            if (displayList.isEmpty()) {
                if (showingSearchResults) {
                    context.text(this.font, Component.translatable("gui.luminabox.platform.no_results"), cardX + 95, cardY + 65, 0xFF888888, false);
                } else {
                    context.text(this.font, Component.translatable("gui.luminabox.platform.empty_list"), cardX + 95, cardY + 65, 0xFF888888, false);
                }
            }

        } else if (activeTab == 2) {
            context.text(this.font, Component.translatable("gui.luminabox.server.title"), cardX + 90, cardY + 18, 0xFFFFFFFF, false);
            ...
            for (int i = 0; i < 9 && (serverScrollIndex + i) < serverList.size(); i++) {
                ...
                context.text(this.font, Component.literal(trackLine), cardX + 95, cardY + 40 + i * 20, color, false);
            }
            if (serverList.isEmpty()) {
                context.text(this.font, Component.translatable("gui.luminabox.server.empty_list"), cardX + 95, cardY + 65, 0xFF888888, false);
            }

        } else if (activeTab == 3) {
            context.text(this.font, Component.translatable("gui.luminabox.rules.title"), cardX + 90, cardY + 15, 0xFFFFFFFF, false);
            
            MusicRuleManager ruleMgr = MusicRuleManager.getInstance();
            context.text(this.font, Component.translatable("gui.luminabox.rules.overworld")
                .append(getRuleSongDisplayName(ruleMgr.getDimensions().get("minecraft:overworld"))), cardX + 95, cardY + 40, 0xFFDDDDDD, false);
            context.text(this.font, Component.translatable("gui.luminabox.rules.nether")
                .append(getRuleSongDisplayName(ruleMgr.getDimensions().get("minecraft:the_nether"))), cardX + 95, cardY + 65, 0xFFDDDDDD, false);
            context.text(this.font, Component.translatable("gui.luminabox.rules.combat")
                .append(getRuleSongDisplayName(ruleMgr.getCombatMusic())), cardX + 95, cardY + 90, 0xFFDDDDDD, false);
            context.text(this.font, Component.translatable("gui.luminabox.rules.boss")
                .append(getRuleSongDisplayName(ruleMgr.getBossMusic())), cardX + 95, cardY + 115, 0xFFDDDDDD, false);

            context.text(this.font, Component.translatable("gui.luminabox.rules.hint"), cardX + 95, cardY + 145, 0xFF888888, false);

        } else if (activeTab == 4) {
            context.text(this.font, Component.translatable("gui.luminabox.settings.title"), cardX + 90, cardY + 15, 0xFFFFFFFF, false);
            context.text(this.font, Component.translatable("gui.luminabox.settings.proxy_title"), cardX + 90, cardY + 100, 0xFFFFFFFF, false);
            context.text(this.font, Component.translatable("gui.luminabox.settings.proxy_host"), cardX + 90, cardY + 140, 0xFF888888, false);
            context.text(this.font, Component.translatable("gui.luminabox.settings.proxy_port"), cardX + 220, cardY + 140, 0xFF888888, false);
        }
        ...
        context.text(this.font, Component.literal(trackTitle), cardX + 95, cardY + 235, ModConfig.getInstance().isUseRpcControl() ? 0xFFFF00FF : 0xFFFFFFFF, false);
        ...
        context.text(this.font, Component.literal(timeStr), cardX + 375, cardY + 235, 0xFFCCCCCC, false);
        ...
        // Volume slider
        context.text(this.font, Component.translatable("gui.luminabox.player.volume"), cardX + 95, cardY + 256, 0xFF888888, false);
        ...
        context.text(this.font, Component.literal(percentageStr), cardX + 220, cardY + 256, 0xFFCCCCCC, false);
    ...
    public boolean mouseDragged(MouseButtonEvent event, double dragX, double dragY) {
        if (handleVolumeAction(event.x(), event.y())) {
            return true;
        }
        if (handleProgressAction(event.x(), event.y())) {
            return true;
        }
