...
public class LuminaBoxFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        PayloadTypeRegistry.clientboundPlay().register(PlayMusicPayload.TYPE, PlayMusicPayload.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(FileUploadPayload.TYPE, FileUploadPayload.STREAM_CODEC);
        PayloadTypeRegistry.clientboundPlay().register(SyncPlaylistPayload.TYPE, SyncPlaylistPayload.STREAM_CODEC);
